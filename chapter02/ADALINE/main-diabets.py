...
def oitentaVinteGD(X, y):
    ###########################
    ### TREINA E CLASSIFICA ###
    slp = AdalineGD(eta=0.0000001, n_iter=10000)
    erros = 0
...
def oitentaVinteSGD(X, y):
    ###########################
    ### TREINA E CLASSIFICA ###
    slp = AdalineSGD(eta=0.0000001, n_iter=400)
    erros = 0
...
X = df.iloc[0:150, [0,1,2,3,4,5,6,7]].values
y = df.iloc[0:150, 8].values
y = np.where(y==0, 1, -1)

print "Teste de dados Diabets com Gradiente Descendente"
...
print "Teste de dados Diabets com Gradiente Stocastico"
for i in range(ITERACOES):
...
print "Teste de dados Diabets com Perceptron"
for i in range(ITERACOES):
